...
folderpath = '/home/ib012512/Documents/Results/Result_kv_no_den/'+args.foldername
...
sfp_std = tfconstant(args.stp_std*np.ones([num_para]))

density = tfconstant([2.8, 3.2, 3.])
# density_std = tfconstant([0.2,0.3,0.5])
# density_std = tfconstant([0.2,0.2,0.3])
